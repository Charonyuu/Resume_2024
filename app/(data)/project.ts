export const projectData = [
  ...
  },
  {
    year: "2023",
    date: "Sep 10",
    title: "Shared Blog about React Custom Hooks & TypeScript & Unit Test",
    image: "project/ithome.png",
    description:
      "This is a series of 30 blog posts that introduces how to create custom hooks in React, using TypeScript to define the types of the hooks, and writing unit tests for the custom hooks.",
